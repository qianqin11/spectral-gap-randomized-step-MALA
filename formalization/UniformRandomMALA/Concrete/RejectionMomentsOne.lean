...
/-- Proposition B.1 (`prop:stationary-rejection`) for `p ≥ 1` under the standing first-order, strongly convex
...
/-- Proposition 3.2 (`prop:overlap`) with its full manuscript range and explicit universal
